...
public class GMM {
	 ...
	 */
	public GMM(int dim, int nMix, int label, String gmmFile) {
		this.dim = dim;
		this.nMix = nMix;
		pi = new double[nMix];
		mu = new double[nMix][dim];
	...
	public double[] getPosterior(int[] xt) {
	...
	public double getLogLikelihood(int[] xt) {
		double sum = 0.0;
		for (int i = 0; i < nMix; i++) {
	...
	public double getTotalLogLikelihood(int[][] x) {
		int nData = x.length;
		double totalLh = 0.0;
